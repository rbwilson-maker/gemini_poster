...
\begin{column}{\colwidth}
  ...
  \begin{exampleblock}{A block containing an enumerated list}
  ...
  \begin{block}{Nam cursus consequat egestas}
    ...
    ac ante \textbf{ipsum primis} in faucibus. Etiam sit amet velit eget sem
    euismod tristique. Praesent enim erat, porta vel mattis sed, pharetra sed
    ipsum. Morbi commodo condimentum massa, \textbf{tempus venenatis} massa
    hendrerit quis. 
